...
namespace satCompent.Model
{
    ...
    public struct MsgOfPanel
    {
        ...
        [FieldOffset(36)]
        public float panelVolt;  //帆板电压:V
        [FieldOffset(40)]
        public float panelCurrXP;  //帆板+X电流:mA
        [FieldOffset(44)]
        public float panelTempXP;  //帆板+X温度:℃
        [FieldOffset(48)]
        public float panelCurrXN;  //帆板-X电流:mA
        [FieldOffset(52)]
        public float panelTempXN;  //帆板-X温度:℃
        [FieldOffset(56)]
        public float panelCurrYP;  //帆板+Y电流:mA
        [FieldOffset(60)]
        public float panelTempYP;  //帆板+Y温度:℃
        [FieldOffset(64)]
        public float panelCurrYN;  //帆板-Y电流:mA
        [FieldOffset(68)]
        public float panelTempYN;  //帆板-Y温度:℃

        public MsgOfPanel(string satellite)
        {
            this.name = satellite;
            this.year = 2000;
            this.month = 1;
            ...
            this.panelVolt = this.panelCurrXP = this.panelTempXP = this.panelCurrXN = this.panelTempXN = this.panelCurrYP = this.panelTempYP = this.panelCurrYN = this.panelTempYN = 0;
        }
    }
    ...
    public struct MsgOfVolt
    {
        ...
        [FieldOffset(36)]
        public float lineVolt14;  //+14V母线电压:V
        [FieldOffset(40)]
        public float lineVolt12P;  //+12V电压:V
        [FieldOffset(44)]
        public float lineVolt12N;  //-12V电压:V
        [FieldOffset(48)]
        public float lineVolt5;  //+5V电压:V

        public MsgOfVolt(string satellite)
        {
            this.name = satellite;
            this.year = 2000;
            this.month = 1;
            ...
            this.lineVolt14 = this.lineVolt12P = this.lineVolt12N = this.lineVolt5 = 0;
        }
    }
    ...
    public struct MsgOfTemp
    {
        ...
        [FieldOffset(36)]
        public float tempObc;  //OBC温度:℃
        [FieldOffset(40)]
        public float tempRf;  //RF温度:℃

        public MsgOfTemp(string satellite)
        {
            this.name = satellite;
            this.year = 2000;
            this.month = 1;
