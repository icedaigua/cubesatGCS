...
namespace satCompent.Helper
{
    ...
    public class Configuration
    {
        ...
        /// 默认的配置文件存储路径
        /// </summary>
        private static readonly string defaultConfPath = System.AppDomain.CurrentDomain.BaseDirectory + @"\config.json";
        ...
        {
            // 构建配置信息的json字符串
            string confStr = JsonMapper.ToJson(conf.ConfigInfo);
        ...
        public static Configuration Read(string path)
        {
            ...
            using (System.IO.StreamReader sr = new System.IO.StreamReader(path, defaultConfEncoding))
            {
                try
                {
                    ...
                    // 解析得到配置信息
                    Dictionary<string, object> confInfo = JsonMapper.ToObject<Dictionary<string, object>>(confStr);
